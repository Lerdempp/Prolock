...
import gidon from "../../assets/images/Card4.svg"; // Ürün görseli
...
const Card4 = () => {
  ...
  const handleImageClick = () => {
    navigate("/SMM"); // Yönlendirme yapılacak rota
  };
  ...
  const handleTextClick = () => {
    navigate("/SMM"); // Yazıya tıklama ile yönlendirme
  };
      ...
      >
        ...
        >
          ...
          <p
            ...
            onClick={handleTextClick} // Yazıya tıklama ile yönlendirme
          >
            Scotter Motocyle ‘’Mount’’
          </p>
        </div>
